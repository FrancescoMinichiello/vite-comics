<script>
import AppMainCardListCurrentSeries from './AppMainCardListCurrentSeries.vue';
export default{
  data(){
    return{
     cardItems: [
...
<main class="p-5">
    <div class="row justify-content-center">
      <div class="col-7 d-flex flex-wrap justify-content-center gap-3">
        <AppMainCardListCurrentSeries
        v-for="(cardItem, index) in cardItems" :key="index"
        :cardThumbs="cardItem.thumb"
        :cardSeries="cardItem.series"
        />
      </div>
    </div>
...
.load-more-btn{
  background-color: #5774F3;
  padding: 10px 50px;
  color: white;
  border: 1px solid #5774F3;
